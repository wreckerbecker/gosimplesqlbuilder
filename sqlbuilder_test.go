...
func TestBuilder_Select(t *testing.T) {
	...
	expectedSql := "SELECT a,b,c FROM testing t JOIN table_x x ON x.tid=t.id WHERE t.a=$1 AND t.b=$2 AND (t.e=$3 OR (t.d=$4 and t.z=$5)) GROUP BY t.category asc ORDER BY t.a desc,t.b desc LIMIT 10 OFFSET 10"
